...
app.post('/api/mail', (req, res) => {
    ...
    <p style="border-bottom: 1px dashed lightgreen;margin: 0;padding-bottom: 1rem; color: lightgreen; font-size: 1.25rem;">blog Message</p>
...
邮箱: ${req.body.address}
    ...
    `
    mail.send('287668256@qq.com','您的博客有一条新的评论',content, res)
